...
from desktop import views2 as desktop_views2
...
dynamic_patterns += [
  ...
  re_path(r'^desktop/api2/xo_docs/?$', desktop_views2.DocsView.as_view()),  # get doc/dir by path or UUID
  re_path(r'^desktop/api2/xo_doc/?$', desktop_views2.DocView.as_view()),  # get doc/dir by path or UUID
