...
export HADOOP_CONF_DIR=$WORK_DIR/src/main/resources/hb_c4
export HDFS_CONF_DIR=$HADOOP_CONF_DIR
export HBASE_CONF_DIR=$HADOOP_CONF_DIR
export KRB5_CONFIG=$HBASE_CONF_DIR/krb5.conf
export HADOOP_OPTS="-Djava.security.krb5.conf=$KRB5_CONFIG\
 -Dzookeeper.server.principal=zookeeper/centos4@EXAMPLE.COM\
