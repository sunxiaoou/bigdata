...
public final class Utility {
  ...
  public static void createTable(Admin admin, String tableName, int splitCount,
    ...
    ColumnFamilyDescriptor cfDescriptor =
      ColumnFamilyDescriptorBuilder.newBuilder(COLUMN_FAMILY.getBytes()).setScope(1).build();
    TableDescriptor tableDescriptor = tableDescriptorBuilder.setColumnFamily(cfDescriptor).build();
